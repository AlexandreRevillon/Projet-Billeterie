...
<!--------------------- Fin de la barre de navigation --------------------->
    ...
    <?php
      ...
      $sql="select t.libt,s.libs,v.codebv,v.dateheurevalid,v.quantite from validation v natural join titretransport t natural join bornevalidation b natural join station s where numc='$carte'";
      $result=pg_query($sql);
